...
def _summarize_survival_subset(dataset, indices):
    summary = {
        ...
        for stage_id in range(len(STAGE_SPECS))
    }
...
def main():
    ...
    full_dataset = RenjiTacrolimusSurvivalDataset(
    ...
    query_schema = full_dataset.task_schema["tacrolimus_abnormal_survival"]
    query_texts = {}
