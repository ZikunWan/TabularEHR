...
for TASK_NAME in "${TASKS[@]}"; do
  KWARGS+="{\"root_dir\":\"${DATA_DIR}\",\"sample_info_path\":\"${DATA_DIR}/task_index/train/${TASK_NAME}.csv\",\"lazy_mode\":true,\"shuffle\":false,\"table_mode\":\"table_only\",\"itemid_representation\":\"code\",\"return_meds\":true},"
done
KWARGS="${KWARGS%,}]"
