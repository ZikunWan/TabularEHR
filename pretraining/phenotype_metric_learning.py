...
from transformers import AutoTokenizer, HfArgumentParser, PreTrainedModel, Trainer, TrainingArguments, set_seed
...
def load_precomputed_query_embeddings(
    ...
    if not os.path.exists(cache_path):
        raise FileNotFoundError(
            ...
            "Run precompute_phenotype_queries.py first."
        )
    ...
    if missing_keys:
        ...
        raise ValueError(
            ...
            f"(examples: {preview}). Run precompute_phenotype_queries.py again."
        )
    ...
    def __init__(
        ...
        if not os.path.exists(manifest_path):
            raise FileNotFoundError(
                ...
                "Run scripts/pretraining/build_phenotype_metric_samples.sh first."
            )
        ...
        if self.manifest.get("phenotype_spec_fingerprint") != expected_spec_fingerprint:
            raise ValueError(
                ...
                "Re-run scripts/pretraining/build_phenotype_metric_samples.sh."
            )
